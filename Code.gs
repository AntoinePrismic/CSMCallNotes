...
function resetFields() {
  ...
  if(spreadsheetName.match("Onboarding Introcall Notes")){
    ...
    if(spreadsheetName.match("Antoine")){introcallNotesSheet.getRange("B1").setValue("Antoine")}
    else if(spreadsheetName.match("Noor")){introcallNotesSheet.getRange("B1").setValue("Noor")}
    else if(spreadsheetName.match("Simon")){introcallNotesSheet.getRange("B1").setValue("Simon")}
  }
    ...
    if(spreadsheetName.match("Nouha")){introcallNotesSheet.getRange("B1").setValue("Nouha")}
    else if(spreadsheetName.match("Andrea")){introcallNotesSheet.getRange("B1").setValue("Andrea")}
  }
  else if(spreadsheetName.match("CSM Call Notes")){
    introcallNotesSheet.getRange("B8").setValue("CSM call");
    if(spreadsheetName.match("Sarah")){introcallNotesSheet.getRange("B1").setValue("Sarah")}
  }
  else{SpreadsheetApp.getUi().alert("Nope");}
}
