...
currentWorkflow = [
  introcallNotesSheet.getRange("E13").getValue(),
  introcallNotesSheet.getRange("E14").getValue(),
  introcallNotesSheet.getRange("E15").getValue(),
  introcallNotesSheet.getRange("E16").getValue()
];
whyPrismic = [
  introcallNotesSheet.getRange("E17").getValue(),
  introcallNotesSheet.getRange("E18").getValue(),
  introcallNotesSheet.getRange("E19").getValue(),
  introcallNotesSheet.getRange("E20").getValue()
];
valuableInfos = [
...
nextSteps = [
  ...
  introcallNotesSheet.getRange("J8").getValue()
];
...
allNotes =
  ...
  ") Introcall Notes:\n" +
  /**/
  introcallNotesSheet.getRange("A1").getValue() +
  ": " +
  callOwner +
  "\n" +
  introcallNotesSheet.getRange("A8").getValue() +
  ": " +
  callType +
  "\n\n" +
  /**/
  ...
  ")\n\n" +
  /**/
  introcallNotesSheet.getRange("D2").getValue() +
  ": " +
  projectType +
  "\n" +
  introcallNotesSheet.getRange("D3").getValue() +
  ": " +
  numberUsers +
  "\n" +
  introcallNotesSheet.getRange("D4").getValue() +
  ": " +
  framework +
  "\n" +
  introcallNotesSheet.getRange("D5").getValue() +
  ": " +
  numberLanguages +
  "\n" +
  introcallNotesSheet.getRange("D6").getValue() +
  ": " +
  timeline +
  "\n" +
  introcallNotesSheet.getRange("D7").getValue() +
  ": " +
  liveWithPrismic +
  "\n" +
  introcallNotesSheet.getRange("D8").getValue() +
  ": " +
  workWithAgency +
  "\n" +
  introcallNotesSheet.getRange("D9").getValue() +
  ": " +
  heardAboutPrismic +
  "\n\n" +
  /**/
  introcallNotesSheet.getRange("D11").getValue() +
  ": " +
  createdRepo +
  "\n" +
  introcallNotesSheet.getRange("D12").getValue() +
  ": " +
  currentCMS +
  "\n\n" +
  /**/
...
function saveInfos() {
  introcallNotesSheet.getRange("E3").setNumberFormat("@STRING@");
  introcallNotesSheet.getRange("E5").setNumberFormat("@STRING@");
  var ls = SpreadsheetApp.openByUrl(
    "https://docs.google.com/spreadsheets/d/1GF_-Z_qgdDahAy1htljOoL1ZRgANwvjq_vXoN2tR9rw/edit"
  );
...
function resetFields() {
  ...
  if (spreadsheetName.match("Onboarding Introcall Notes")) {
    introcallNotesSheet.getRange("B8").setValue("Onboarding introcall");
    if (spreadsheetName.match("Antoine")) {
      introcallNotesSheet.getRange("B1").setValue("Antoine");
    } else if (spreadsheetName.match("Noor")) {
      introcallNotesSheet.getRange("B1").setValue("Noor");
    } else if (spreadsheetName.match("Simon")) {
      introcallNotesSheet.getRange("B1").setValue("Simon");
    }
  } else if (spreadsheetName.match("High Touch Introcall Notes")) {
    introcallNotesSheet.getRange("B8").setValue("High Touch lead introcall");
    if (spreadsheetName.match("Nouha")) {
      introcallNotesSheet.getRange("B1").setValue("Nouha");
    } else if (spreadsheetName.match("Andrea")) {
      introcallNotesSheet.getRange("B1").setValue("Andrea");
    }
  } else if (spreadsheetName.match("CSM Call Notes")) {
    introcallNotesSheet.getRange("B8").setValue("CSM call");
    if (spreadsheetName.match("Sarah")) {
      introcallNotesSheet.getRange("B1").setValue("Sarah");
    }
  } else {
...
function resetNotes() {
  var response = SpreadsheetApp.getUi().alert(
    "You are about to reset these values.",
    "Do you want to save before erasing?",
